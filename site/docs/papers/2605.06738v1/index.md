...
- **论文链接**：[https://arxiv.org/pdf/2605.06738v1](https://arxiv.org/pdf/2605.06738v1)
- **状态**：摘要模式

## 原始摘要

Autonomous AI agents now transact at production scale -- 69,000 bots executing 165 million transactions across 50 million USDC in cumulative volume on a single marketplace -- without any shared trust layer between participants. Regulator...
