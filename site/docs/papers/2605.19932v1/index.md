...
- **论文链接**：[https://arxiv.org/pdf/2605.19932v1](https://arxiv.org/pdf/2605.19932v1)
- **状态**：摘要模式

## 原始摘要

Large language model (LLM) agents increasingly operate over long and recurring external contexts, like document corpora and code repositories. Across invocations, existing approaches preserve either the agent's trajectory, passive access...
