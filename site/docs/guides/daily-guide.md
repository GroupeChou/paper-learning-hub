...
- **Spatial Atlas: Compute-Grounded Reasoning for Spatial-Aware Research Agent Benchmarks** | OpenAI | 2026-04-13 | 优先级 975 | 状态 `translated` | [中文笔记](../papers/2604.12102v2/index.md)
...
- **Reasoning-targeted Jailbreak Attacks on Large Reasoning Models via Semantic Triggers and Psychological Framing** | OpenAI | 2026-04-17 | 优先级 974 | 状态 `translated` | [中文笔记](../papers/2604.15725v1/index.md)
...
- **Benchmarks for Trajectory Safety Evaluation and Diagnosis in OpenClaw and Codex: ATBench-Claw and ATBench-CodeX** | OpenAI | 2026-04-16 | 优先级 963 | 状态 `translated` | [中文笔记](../papers/2604.14858v1/index.md)
...
- **Evaluating Multi-Hop Reasoning in RAG Systems: A Comparison of LLM-Based Retriever Evaluation Strategies** | OpenAI | 2026-04-20 | 优先级 962 | 状态 `queued` | 待生成
...
- **Local-Splitter: A Measurement Study of Seven Tactics for Reducing Cloud LLM Token Usage on Coding-Agent Workloads** | OpenAI | 2026-04-14 | 优先级 956 | 状态 `queued` | 待生成
...
- **Owner-Harm: A Missing Threat Model for AI Agent Safety** | Microsoft | 2026-04-20 | 优先级 927 | 状态 `queued` | 待生成
...
- **Context Kubernetes: Declarative Orchestration of Enterprise Knowledge for Agentic AI Systems** | Microsoft | 2026-04-13 | 优先级 910 | 状态 `queued` | 待生成
...
- **QuantClaw: Precision Where It Matters for OpenClaw** | 智谱 | 2026-04-24 | 优先级 906 | 状态 `queued` | 待生成
...
- **Agentic Aggregation for Parallel Scaling of Long-Horizon Agentic Tasks** | 智谱 | 2026-04-13 | 优先级 900 | 状态 `queued` | 待生成
...
- **Forecast Sports Outcomes under Efficient Market Hypothesis: Theoretical and Experimental Analysis of Odds-Only and Generalised Linear Models** | 智谱 | 2026-04-19 | 优先级 891 | 状态 `queued` | 待生成
