...
> Frontier Red Team research exploring the next phase of Project Fetch, investigating advanced AI capabilities and their implications.

### [Agentic coding and persistent returns to expertise](https://www.anthropic.com/research/claude-code-expertise)

> Economic Research study examining how agentic coding tools deliver persistent returns to expertise across software development tasks.

### [Paving the way for agents in biology](https://www.anthropic.com/research/agents-in-biology)

> Science research exploring how AI agents can accelerate biological research and experimental workflows.

### [Measuring LLMs' impact on N-day exploits](https://www.anthropic.com/research/n-days)

> Frontier Red Team study quantifying how large language models affect the speed and effectiveness of N-day vulnerability exploitation.

### [Making Claude a chemist](https://www.anthropic.com/research/making-claude-a-chemist)

> Science research demonstrating Claude's capabilities in chemistry tasks including molecular reasoning and reaction prediction.
...
> Frontier Red Team research mapping AI-enabled cyber threats using the LLM ATT&CK Navigator framework for systematic threat analysis.
...
> Research on Meta's advanced AI scaling framework covering safety standards, rigorous testing, and deployment safeguards for frontier models.
...
> 报告由 Paper Hub v2.0 自动生成 · 16:21 UTC
