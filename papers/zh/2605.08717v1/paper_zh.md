...
<div class="paper-meta">
  ...
  <div class="paper-meta-item">
    ...
    <span class="paper-meta-value">2026-05-09</span>
  </div>
</div>
...
- **论文链接**：[https://arxiv.org/pdf/2605.08717v1](https://arxiv.org/pdf/2605.08717v1)
- **状态**：摘要模式

## 原始摘要

Software engineering agents are increasingly deployed in evaluable engineering environments, yet post-failure recovery remains costly, manual, and ad hoc. Existing systems expose traces or generate follow-up feedback, but they do not con...
