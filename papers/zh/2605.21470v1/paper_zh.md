...
- **论文链接**：[https://arxiv.org/pdf/2605.21470v1](https://arxiv.org/pdf/2605.21470v1)
- **状态**：摘要模式

## 原始摘要

Computer-use agents (CUA) automate tasks specified with natural language such as "order the cheapest item from Taco Bell" by generating sequences of calls to tools such as click, type, and scroll on a browser. Current implementations fol...
